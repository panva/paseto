 ...
 * @category Key Management
 */
export declare const GenerateKeyFactory: ReturnType<typeof LocalGenerateKey<4, LocalKey>>;
/**
 * Built-in PASERK k4.local key-import capability factory.
 *
 * @category Key Management
 */
export declare const ImportKeyFactory: ReturnType<typeof LocalImportKey<4, LocalKey>>;
/**
 * Built-in PASERK k4.local key-export capability factory.
 *
 * @category Key Management
 */
export declare const ExportKeyFactory: ReturnType<typeof LocalExportKey<4, LocalKey>>;
/**
 * Built-in PASERK k4 wrapping-key generation capability factory.
 *
 * @category Key Wrapping
 */
export declare const GenerateWrappingKeyFactory: ReturnType<typeof LocalGenerateWrappingKey<4, WrappingKey>>;
/**
 * Built-in PASERK k4 wrapping-key import capability factory.
 *
 * @category Key Wrapping
 */
export declare const ImportWrappingKeyFactory: ReturnType<typeof LocalImportWrappingKey<4, WrappingKey>>;
/**
 * Built-in PASERK k4 wrapping-key export capability factory.
 *
 * @category Key Wrapping
 */
export declare const ExportWrappingKeyFactory: ReturnType<typeof LocalExportWrappingKey<4, WrappingKey>>;
